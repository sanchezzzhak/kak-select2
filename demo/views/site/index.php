...
<?php $form = ActiveForm::begin() ?>
   ...
   <div class="row filter-block back-grey">
    ...
    <style>
        ...
        .select2-container.select2-container--focus .select2-selection--multiple .select2-selection__clear{
            top: 7px !important;
        }
        ...
        .select2-container--default.select2-container--disabled .select2-selection--multiple .select2-selection__rendered {
            color: #ffffff50; }
        [class~=select2-container] .select2-selection--multiple {
            padding-right: 20px;
        }

        [class~=select2-container] .select2-selection--multiple .select2-selection__placeholder {
            color: #fff;
        }
